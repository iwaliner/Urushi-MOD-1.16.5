...
@OnlyIn(Dist.CLIENT)
public abstract class AbstractFryerScreen<T extends AbstractFryerContainer> extends ContainerScreen<T>
       // implements IRecipeShownListener
{
    ...
    public AbstractFryerScreen(T p_i51104_1_, AbstractRecipeBookGui p_i51104_2_, PlayerInventory p_i51104_3_, ITextComponent p_i51104_4_, ResourceLocation p_i51104_5_) {
