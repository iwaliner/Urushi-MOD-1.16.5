...
public abstract class AbstractFryerContainer extends RecipeBookContainer<IInventory> {
    private final IInventory container;
    private final IIntArray data;
    protected final World level;
    private final IRecipeType<? extends FryingRecipe> recipeType;
    private final RecipeBookCategory recipeBookType;



    protected AbstractFryerContainer(ContainerType<?> p_i241921_1_, IRecipeType<? extends FryingRecipe> p_i241921_2_, RecipeBookCategory p_i241921_3_, int p_i241921_4_, PlayerInventory p_i241921_5_) {
        this(p_i241921_1_, p_i241921_2_, p_i241921_3_, p_i241921_4_, p_i241921_5_, new Inventory(3), new IntArray(4));
    }

    protected AbstractFryerContainer(ContainerType<?> p_i241922_1_, IRecipeType<? extends FryingRecipe> p_i241922_2_, RecipeBookCategory p_i241922_3_, int p_i241922_4_, PlayerInventory p_i241922_5_, IInventory p_i241922_6_, IIntArray p_i241922_7_) {
        ...
        this.addSlot(new FryerFuelSlot(this, p_i241922_6_, 1, 56, 53));
