...
public class SweetfishBucketItem extends BucketItem {
    public SweetfishBucketItem(Fluid p_i49025_1_, Properties p_i49025_2_) {
    ...
    private void spawn(ServerWorld p_205357_1_, ItemStack p_205357_2_, BlockPos p_205357_3_) {
        Entity entity = EntityRegister.SweetfishEntity.get().spawn(p_205357_1_, p_205357_2_, (PlayerEntity)null, p_205357_3_, SpawnReason.BUCKET, true, false);
        if (entity != null) {
