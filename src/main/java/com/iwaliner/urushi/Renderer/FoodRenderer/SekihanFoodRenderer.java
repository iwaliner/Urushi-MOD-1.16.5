...
public class SekihanFoodRenderer<T extends SekihanFoodEntity> extends EntityRenderer<T> {
    ...
    public SekihanFoodRenderer(EntityRendererManager p_i47208_1_) {
        super(p_i47208_1_);
        this.TEXTURE_LOCATION=new ResourceLocation("urushi:textures/entity/food/sekihan.png");
        model = new RiceFoodModel<>();
    }
    public void render(SekihanFoodEntity entity, float p_225623_2_, float p_225623_3_, MatrixStack p_225623_4_, IRenderTypeBuffer p_225623_5_, int p_225623_6_) {
