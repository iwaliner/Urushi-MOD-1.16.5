...
public class TKGFoodRenderer<T extends TKGFoodEntity> extends EntityRenderer<T> {
    ...
    public TKGFoodRenderer(EntityRendererManager p_i47208_1_) {
        super(p_i47208_1_);
        this.TEXTURE_LOCATION=new ResourceLocation("urushi:textures/entity/food/tkg.png");
        model = new RiceFoodModel<>();
    }
    public void render(TKGFoodEntity entity, float p_225623_2_, float p_225623_3_, MatrixStack p_225623_4_, IRenderTypeBuffer p_225623_5_, int p_225623_6_) {
