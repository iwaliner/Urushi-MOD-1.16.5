...
public class ButadonFoodRenderer<T extends ButadonFoodEntity> extends EntityRenderer<T> {
    ...
    public ButadonFoodRenderer(EntityRendererManager p_i47208_1_) {
        super(p_i47208_1_);
        this.TEXTURE_LOCATION=new ResourceLocation("urushi:textures/entity/food/butadon.png");
        model = new RiceFoodModel<>();
    }
    public void render(ButadonFoodEntity entity, float p_225623_2_, float p_225623_3_, MatrixStack p_225623_4_, IRenderTypeBuffer p_225623_5_, int p_225623_6_) {
