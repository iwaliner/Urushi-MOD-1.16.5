...
public class WoodenCabinetrySlabTileEntity extends LockableLootTileEntity {
    private NonNullList<ItemStack> items = NonNullList.withSize(27, ItemStack.EMPTY);
    private int openCount;
    public WoodenCabinetrySlabTileEntity(TileEntityType<?> p_i48289_1_) {
        super(p_i48289_1_);
    }
    public WoodenCabinetrySlabTileEntity(){
        this(TileEntitiesRegister.WoodenCabinetrySlabTile.get());}
    ...
    protected ITextComponent getDefaultName() {
        return new TranslationTextComponent("container.woodencabinetryslab");
    }
    ...
    public void startOpen(PlayerEntity p_174889_1_) {
        if (!p_174889_1_.isSpectator()) {
            ...
            boolean flag = blockstate.getValue(WoodenCabinetrySlabBlock.OPEN);
            if (!flag) {
    ...
    private void updateBlockState(BlockState p_213963_1_, boolean p_213963_2_) {
        this.level.setBlock(this.getBlockPos(), p_213963_1_.setValue(WoodenCabinetrySlabBlock.OPEN, Boolean.valueOf(p_213963_2_)), 3);
    }

    private void playSound(BlockState p_213965_1_, SoundEvent p_213965_2_) {
        Vector3i vector3i = p_213965_1_.getValue(WoodenCabinetrySlabBlock.FACING).getNormal();
