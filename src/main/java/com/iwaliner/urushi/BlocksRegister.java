...
//   public static final RegistryObject<Block> BlackUrushiStrippedLog;
  //  public static final RegistryObject<Block> BlackUrushiStrippedWood;
    ...
    public static final RegistryObject<Block> DoubledWoodenCabinetry;
    public static final RegistryObject<Block> RedUrushiWoodenCabinetry;
    public static final RegistryObject<Block> RedUrushiWoodenCabinetrySlab;
    public static final RegistryObject<Block> DoubledRedUrushiWoodenCabinetry;
    public static final RegistryObject<Block> HiwadabukiBlock;
    public static final RegistryObject<Block> HiwadabukiSlab;
    public static final RegistryObject<Block> HiwadabukiStairs;
    public static final RegistryObject<Block> HiwadabukiRoof45;
    public static final RegistryObject<Block> HiwadabukiRoof225;
    ...
    static {
        ...
        JapaneseApricotSapling = BLOCKS.register("japanese_apricot_sapling", () -> {return new SaplingBlock(new JapaneseApricotTree(),AbstractBlock.Properties.of(Material.PLANT, MaterialColor.COLOR_PINK).sound(SoundType.GRASS).noCollission().instabreak().randomTicks());});
        JapaneseApricotLeaves = BLOCKS.register("japanese_apricot_leaves", () -> {return new LeavesBlock(AbstractBlock.Properties.of(Material.LEAVES, MaterialColor.COLOR_PINK).strength(0.2F).randomTicks().sound(SoundType.GRASS).noOcclusion().randomTicks());});
        JapaneseApricotGlowingSapling = BLOCKS.register("glowing_japanese_apricot_sapling", () -> {return new GlowingSaplingBlock(new GlowingJapaneseApricotTree(),AbstractBlock.Properties.of(Material.PLANT, MaterialColor.COLOR_PINK).sound(SoundType.GRASS).noCollission().instabreak().randomTicks().lightLevel((p_235470_0_) -> {return 15;}));});
        JapaneseApricotGlowingLeaves = BLOCKS.register("glowing_japanese_apricot_leaves", () -> {return new LeavesBlock(AbstractBlock.Properties.of(Material.LEAVES, MaterialColor.COLOR_PINK).strength(0.2F).randomTicks().sound(SoundType.GRASS).noOcclusion().randomTicks().lightLevel((p_235470_0_) -> {return 15;}));});
        JapaneseApricotStrippedLog = BLOCKS.register("stripped_japanese_apricot_log", () -> {return new RotatedPillarBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_PINK).harvestTool(ToolType.AXE).sound(SoundType.WOOD).harvestLevel(0).strength(2.0F));});
        JapaneseApricotLog = BLOCKS.register("japanese_apricot_log", () -> {return new StrippableLogBlock(JapaneseApricotStrippedLog.get(),0,AbstractBlock.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_PINK).harvestTool(ToolType.AXE).sound(SoundType.WOOD).harvestLevel(0).strength(2.0F));});
        JapaneseApricotStrippedWood = BLOCKS.register("stripped_japanese_apricot_wood", () -> {return new RotatedPillarBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_PINK).harvestTool(ToolType.AXE).sound(SoundType.WOOD).harvestLevel(0).strength(2.0F));});
        JapaneseApricotWood = BLOCKS.register("japanese_apricot_wood", () -> {return new StrippableLogBlock(JapaneseApricotStrippedWood.get(),0,AbstractBlock.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_PINK).harvestTool(ToolType.AXE).sound(SoundType.WOOD).harvestLevel(0).strength(2.0F));});
        JapaneseApricotPlanks = BLOCKS.register("japanese_apricot_planks", () -> {return new Block(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_PINK).harvestTool(ToolType.AXE).sound(SoundType.WOOD).harvestLevel(0).strength(2.0F, 3.0F));});
        JapaneseApricotSlab = BLOCKS.register("japanese_apricot_slab", () -> {return new SlabBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_PINK).harvestTool(ToolType.AXE).sound(SoundType.WOOD).harvestLevel(0).strength(1.0F, 10.0F).dynamicShape());});
        JapaneseApricotStairs = BLOCKS.register("japanese_apricot_stairs", () -> {return new StairsBlock(((Block)JapaneseApricotPlanks.get()).defaultBlockState(), AbstractBlock.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_PINK).harvestTool(ToolType.AXE).sound(SoundType.WOOD).harvestLevel(0).strength(1.0F, 10.0F));});
        JapaneseApricotFence = BLOCKS.register("japanese_apricot_fence", () -> {return new FenceBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_PINK).harvestTool(ToolType.AXE).sound(SoundType.WOOD).strength(2.0F, 3.0F));});
        JapaneseApricotFenceGate = BLOCKS.register("japanese_apricot_fence_gate", () -> {return new FenceGateBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_PINK).harvestTool(ToolType.AXE).sound(SoundType.WOOD).strength(2.0F, 3.0F));});
        JapaneseApricotDoor = BLOCKS.register("japanese_apricot_door", () -> {return new DoorBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_PINK).harvestTool(ToolType.AXE).sound(SoundType.WOOD).strength(2.0F, 3.0F).noOcclusion());});
        JapaneseApricotTrapdoor = BLOCKS.register("japanese_apricot_trapdoor", () -> {return new TrapDoorBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_PINK).harvestTool(ToolType.AXE).sound(SoundType.WOOD).strength(2.0F, 3.0F).noOcclusion().isValidSpawn(BlocksRegister::never));});
        JapaneseApricotPressurePlate = BLOCKS.register("japanese_apricot_pressure_plate", () -> {return new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING,AbstractBlock.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_PINK).harvestTool(ToolType.AXE).sound(SoundType.WOOD).strength(0.5F, 3.0F).noCollission());});
        JapaneseApricotButton = BLOCKS.register("japanese_apricot_button", () -> {return new WoodButtonBlock(AbstractBlock.Properties.of(Material.DECORATION, MaterialColor.TERRACOTTA_PINK).harvestTool(ToolType.AXE).sound(SoundType.WOOD).strength(0.5F, 3.0F).noCollission());});
        SmoothJapaneseApricotPlanks = BLOCKS.register("smooth_japanese_apricot_planks", () -> {return new Block(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_PINK).harvestTool(ToolType.AXE).sound(SoundType.WOOD).harvestLevel(0).strength(1.0F, 10.0F));});
        SmoothJapaneseApricotSlab = BLOCKS.register("smooth_japanese_apricot_slab", () -> {return new SlabBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_PINK).harvestTool(ToolType.AXE).sound(SoundType.WOOD).harvestLevel(0).strength(1.0F, 10.0F).dynamicShape());});
        ...
        SakuraSapling = BLOCKS.register("sakura_sapling", () -> {return new SaplingBlock(new SakuraTree(),AbstractBlock.Properties.of(Material.PLANT, MaterialColor.TERRACOTTA_WHITE).sound(SoundType.GRASS).noCollission().instabreak().randomTicks());});
        SakuraBigSapling = BLOCKS.register("big_sakura_sapling", () -> {return new SaplingBlock(new BigSakuraTree(),AbstractBlock.Properties.of(Material.PLANT, MaterialColor.TERRACOTTA_WHITE).sound(SoundType.GRASS).noCollission().instabreak().randomTicks());});
        SakuraLeaves = BLOCKS.register("sakura_leaves", () -> {return new LeavesBlock(AbstractBlock.Properties.of(Material.LEAVES, MaterialColor.TERRACOTTA_WHITE).strength(0.2F).randomTicks().sound(SoundType.GRASS).noOcclusion().randomTicks());});
        SakuraGlowingSapling = BLOCKS.register("glowing_sakura_sapling", () -> {return new GlowingSaplingBlock(new GlowingSakuraTree(),AbstractBlock.Properties.of(Material.PLANT, MaterialColor.TERRACOTTA_WHITE).sound(SoundType.GRASS).noCollission().instabreak().randomTicks().lightLevel((p_235470_0_) -> {return 15;}));});
        SakuraGlowingBigSapling = BLOCKS.register("glowing_big_sakura_sapling", () -> {return new GlowingSaplingBlock(new GlowingBigSakuraTree(),AbstractBlock.Properties.of(Material.PLANT, MaterialColor.TERRACOTTA_WHITE).sound(SoundType.GRASS).noCollission().instabreak().randomTicks().lightLevel((p_235470_0_) -> {return 15;}));});
        SakuraGlowingLeaves = BLOCKS.register("glowing_sakura_leaves", () -> {return new LeavesBlock(AbstractBlock.Properties.of(Material.LEAVES, MaterialColor.TERRACOTTA_WHITE).strength(0.2F).randomTicks().sound(SoundType.GRASS).noOcclusion().randomTicks().lightLevel((p_235470_0_) -> {return 15;}));});
        SakuraStrippedLog = BLOCKS.register("stripped_sakura_log", () -> {return new RotatedPillarBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_ORANGE).harvestTool(ToolType.AXE).sound(SoundType.WOOD).harvestLevel(0).strength(2.0F));});
        SakuraLog = BLOCKS.register("sakura_log", () -> {return new StrippableLogBlock(SakuraStrippedLog.get(),1,AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_ORANGE).harvestTool(ToolType.AXE).sound(SoundType.WOOD).harvestLevel(0).strength(2.0F));});
        SakuraStrippedWood = BLOCKS.register("stripped_sakura_wood", () -> {return new RotatedPillarBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_ORANGE).harvestTool(ToolType.AXE).sound(SoundType.WOOD).harvestLevel(0).strength(2.0F));});
        SakuraWood = BLOCKS.register("sakura_wood", () -> {return new StrippableLogBlock(SakuraStrippedWood.get(),1,AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_ORANGE).harvestTool(ToolType.AXE).sound(SoundType.WOOD).harvestLevel(0).strength(2.0F));});
        SakuraPlanks = BLOCKS.register("sakura_planks", () -> {return new Block(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_ORANGE).harvestTool(ToolType.AXE).sound(SoundType.WOOD).harvestLevel(0).strength(2.0F, 3.0F));});
        SakuraSlab = BLOCKS.register("sakura_slab", () -> {return new SlabBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_ORANGE).harvestTool(ToolType.AXE).sound(SoundType.WOOD).harvestLevel(0).strength(1.0F, 10.0F).dynamicShape());});
        SakuraStairs = BLOCKS.register("sakura_stairs", () -> {return new StairsBlock(((Block)SakuraPlanks.get()).defaultBlockState(), AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_ORANGE).harvestTool(ToolType.AXE).sound(SoundType.WOOD).harvestLevel(0).strength(1.0F, 10.0F));});
        SakuraFence = BLOCKS.register("sakura_fence", () -> {return new FenceBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_ORANGE).harvestTool(ToolType.AXE).sound(SoundType.WOOD).strength(2.0F, 3.0F));});
        SakuraFenceGate = BLOCKS.register("sakura_fence_gate", () -> {return new FenceGateBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_ORANGE).harvestTool(ToolType.AXE).sound(SoundType.WOOD).strength(2.0F, 3.0F));});
        SakuraDoor = BLOCKS.register("sakura_door", () -> {return new DoorBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_ORANGE).harvestTool(ToolType.AXE).sound(SoundType.WOOD).strength(2.0F, 3.0F).noOcclusion());});
        SakuraTrapdoor = BLOCKS.register("sakura_trapdoor", () -> {return new TrapDoorBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_ORANGE).harvestTool(ToolType.AXE).sound(SoundType.WOOD).strength(2.0F, 3.0F).noOcclusion().isValidSpawn(BlocksRegister::never));});
        SakuraPressurePlate = BLOCKS.register("sakura_pressure_plate", () -> {return new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING,AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_ORANGE).harvestTool(ToolType.AXE).sound(SoundType.WOOD).strength(0.5F, 3.0F).noCollission());});
        SakuraButton = BLOCKS.register("sakura_button", () -> {return new WoodButtonBlock(AbstractBlock.Properties.of(Material.DECORATION, MaterialColor.COLOR_ORANGE).harvestTool(ToolType.AXE).sound(SoundType.WOOD).strength(0.5F, 3.0F).noCollission());});
        SmoothSakuraPlanks = BLOCKS.register("smooth_sakura_planks", () -> {return new Block(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_ORANGE).harvestTool(ToolType.AXE).sound(SoundType.WOOD).harvestLevel(0).strength(1.0F, 10.0F));});
        SmoothSakuraSlab = BLOCKS.register("smooth_sakura_slab", () -> {return new SlabBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_ORANGE).harvestTool(ToolType.AXE).sound(SoundType.WOOD).harvestLevel(0).strength(1.0F, 10.0F).dynamicShape());});
        SmoothSakuraStairs = BLOCKS.register("smooth_sakura_stairs", () -> {return new StairsBlock(((Block)SmoothSakuraPlanks.get()).defaultBlockState(), AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_ORANGE).harvestTool(ToolType.AXE).sound(SoundType.WOOD).harvestLevel(0).strength(1.0F, 10.0F));});
        ...
        CypressStrippedLog = BLOCKS.register("stripped_cypress_log", () -> {return new RotatedPillarBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.SAND).harvestTool(ToolType.AXE).sound(SoundType.WOOD).harvestLevel(0).strength(2.0F));});
        CypressLog = BLOCKS.register("cypress_log", () -> {return new StrippableLogBlock(CypressStrippedLog.get(),2,AbstractBlock.Properties.of(Material.SAND, MaterialColor.WOOD).harvestTool(ToolType.AXE).sound(SoundType.WOOD).harvestLevel(0).strength(2.0F));});
        CypressStrippedWood = BLOCKS.register("stripped_cypress_wood", () -> {return new RotatedPillarBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.SAND).harvestTool(ToolType.AXE).sound(SoundType.WOOD).harvestLevel(0).strength(2.0F));});
        CypressWood = BLOCKS.register("cypress_wood", () -> {return new StrippableLogBlock(CypressStrippedWood.get(),2,AbstractBlock.Properties.of(Material.SAND, MaterialColor.WOOD).harvestTool(ToolType.AXE).sound(SoundType.WOOD).harvestLevel(0).strength(2.0F));});
        CypressPlanks = BLOCKS.register("cypress_planks", () -> {return new Block(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.SAND).harvestTool(ToolType.AXE).sound(SoundType.WOOD).harvestLevel(0).strength(2.0F, 3.0F));});
        CypressSlab = BLOCKS.register("cypress_slab", () -> {return new SlabBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.SAND).harvestTool(ToolType.AXE).sound(SoundType.WOOD).harvestLevel(0).strength(1.0F, 10.0F).dynamicShape());});
        CypressStairs = BLOCKS.register("cypress_stairs", () -> {return new StairsBlock(((Block)CypressPlanks.get()).defaultBlockState(), AbstractBlock.Properties.of(Material.WOOD, MaterialColor.SAND).harvestTool(ToolType.AXE).sound(SoundType.WOOD).harvestLevel(0).strength(1.0F, 10.0F));});
        CypressFence = BLOCKS.register("cypress_fence", () -> {return new FenceBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.SAND).harvestTool(ToolType.AXE).sound(SoundType.WOOD).strength(2.0F, 3.0F));});
        CypressFenceGate = BLOCKS.register("cypress_fence_gate", () -> {return new FenceGateBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.SAND).harvestTool(ToolType.AXE).sound(SoundType.WOOD).strength(2.0F, 3.0F));});
        CypressDoor = BLOCKS.register("cypress_door", () -> {return new DoorBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.SAND).harvestTool(ToolType.AXE).sound(SoundType.WOOD).strength(2.0F, 3.0F).noOcclusion());});
        CypressTrapdoor = BLOCKS.register("cypress_trapdoor", () -> {return new TrapDoorBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.SAND).harvestTool(ToolType.AXE).sound(SoundType.WOOD).strength(2.0F, 3.0F).noOcclusion().isValidSpawn(BlocksRegister::never));});
        CypressPressurePlate = BLOCKS.register("cypress_pressure_plate", () -> {return new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING,AbstractBlock.Properties.of(Material.WOOD, MaterialColor.SAND).harvestTool(ToolType.AXE).sound(SoundType.WOOD).strength(0.5F, 3.0F).noCollission());});
        CypressButton = BLOCKS.register("cypress_button", () -> {return new WoodButtonBlock(AbstractBlock.Properties.of(Material.DECORATION, MaterialColor.SAND).harvestTool(ToolType.AXE).sound(SoundType.WOOD).strength(0.5F, 3.0F).noCollission());});
        SmoothCypressPlanks = BLOCKS.register("smooth_cypress_planks", () -> {return new Block(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.SAND).harvestTool(ToolType.AXE).sound(SoundType.WOOD).harvestLevel(0).strength(1.0F, 10.0F));});
        SmoothCypressSlab = BLOCKS.register("smooth_cypress_slab", () -> {return new SlabBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.SAND).harvestTool(ToolType.AXE).sound(SoundType.WOOD).harvestLevel(0).strength(1.0F, 10.0F).dynamicShape());});
        SmoothCypressStairs = BLOCKS.register("smooth_cypress_stairs", () -> {return new StairsBlock(((Block)SmoothCypressPlanks.get()).defaultBlockState(), AbstractBlock.Properties.of(Material.WOOD, MaterialColor.SAND).harvestTool(ToolType.AXE).sound(SoundType.WOOD).harvestLevel(0).strength(1.0F, 10.0F));});
        ...
        DoubledWoodenCabinetry = BLOCKS.register("doubled_wooden_cabinetry", () -> {return new DoubledWoodenCabinetryBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_BLACK).harvestTool(ToolType.AXE).sound(SoundType.WOOD).harvestLevel(0).strength(1.0F, 10.0F).noOcclusion());});
        WoodenCabinetry = BLOCKS.register("wooden_cabinetry", () -> {return new WoodenCabinetryBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_BLACK).harvestTool(ToolType.AXE).sound(SoundType.WOOD).harvestLevel(0).strength(1.0F, 10.0F).noOcclusion());});
        WoodenCabinetrySlab = BLOCKS.register("wooden_cabinetry_slab", () -> {return new WoodenCabinetrySlabBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_BLACK).harvestTool(ToolType.AXE).sound(SoundType.WOOD).harvestLevel(0).strength(1.0F, 10.0F).noOcclusion().dynamicShape());});
        DoubledRedUrushiWoodenCabinetry = BLOCKS.register("doubled_red_urushi_wooden_cabinetry", () -> {return new DoubledWoodenCabinetryBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_RED).harvestTool(ToolType.AXE).sound(SoundType.WOOD).harvestLevel(0).strength(1.0F, 10.0F).noOcclusion());});
        RedUrushiWoodenCabinetry = BLOCKS.register("red_urushi_wooden_cabinetry", () -> {return new WoodenCabinetryBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_RED).harvestTool(ToolType.AXE).sound(SoundType.WOOD).harvestLevel(0).strength(1.0F, 10.0F).noOcclusion());});
        RedUrushiWoodenCabinetrySlab = BLOCKS.register("red_urushi_wooden_cabinetry_slab", () -> {return new WoodenCabinetrySlabBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_RED).harvestTool(ToolType.AXE).sound(SoundType.WOOD).harvestLevel(0).strength(1.0F, 10.0F).noOcclusion().dynamicShape());});
        ...
        JapaneseApricotParapet = BLOCKS.register("japanese_apricot_parapet", () -> {return new ParapetBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.TERRACOTTA_PINK).harvestTool(ToolType.AXE).sound(SoundType.WOOD).harvestLevel(0).strength(2.0F, 3.0F));});
        SakuraParapet = BLOCKS.register("sakura_parapet", () -> {return new ParapetBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_ORANGE).harvestTool(ToolType.AXE).sound(SoundType.WOOD).harvestLevel(0).strength(2.0F, 3.0F));});
        CypressParapet = BLOCKS.register("cypress_parapet", () -> {return new ParapetBlock(AbstractBlock.Properties.of(Material.WOOD, MaterialColor.SAND).harvestTool(ToolType.AXE).sound(SoundType.WOOD).harvestLevel(0).strength(2.0F, 3.0F));});
        ...
        ThatchedBlock = BLOCKS.register("thatched_block", () -> {return new Block(AbstractBlock.Properties.of(Material.GRASS, MaterialColor.TERRACOTTA_YELLOW).harvestTool(ToolType.SHOVEL).sound(SoundType.GRASS).harvestLevel(0).strength(0.5F, 3.0F));});
        ThatchedSlab = BLOCKS.register("thatched_slab", () -> {return new SlabBlock(AbstractBlock.Properties.of(Material.GRASS, MaterialColor.TERRACOTTA_YELLOW).harvestTool(ToolType.SHOVEL).sound(SoundType.GRASS).harvestLevel(0).strength(0.5F, 3.0F).dynamicShape());});
        ThatchedStairs = BLOCKS.register("thatched_stairs", () -> {return new StairsBlock(((Block)ThatchedBlock.get()).defaultBlockState(), AbstractBlock.Properties.of(Material.GRASS, MaterialColor.TERRACOTTA_YELLOW).harvestTool(ToolType.SHOVEL).sound(SoundType.GRASS).harvestLevel(0).strength(0.5F, 3.0F));});
        ...
        ThatchedRoof45 = BLOCKS.register("thatched_roof_45", () -> {return new Roof45Block(AbstractBlock.Properties.of(Material.GRASS, MaterialColor.TERRACOTTA_YELLOW).harvestTool(ToolType.SHOVEL).sound(SoundType.GRASS).harvestLevel(0).strength(0.5F, 3.0F).noOcclusion().dynamicShape());});
        ThatchedRoof225 = BLOCKS.register("thatched_roof_225", () -> {return new Roof225Block(AbstractBlock.Properties.of(Material.GRASS, MaterialColor.TERRACOTTA_YELLOW).harvestTool(ToolType.SHOVEL).sound(SoundType.GRASS).harvestLevel(0).strength(0.5F, 3.0F).noOcclusion().dynamicShape());});
        ...
        HiwadabukiBlock = BLOCKS.register("hiwadabuki_block", () -> {return new Block(AbstractBlock.Properties.of(Material.GRASS, MaterialColor.TERRACOTTA_BLACK).harvestTool(ToolType.SHOVEL).sound(SoundType.GRASS).harvestLevel(0).strength(0.5F, 3.0F));});
        HiwadabukiSlab = BLOCKS.register("hiwadabuki_slab", () -> {return new SlabBlock(AbstractBlock.Properties.of(Material.GRASS, MaterialColor.TERRACOTTA_BLACK).harvestTool(ToolType.SHOVEL).sound(SoundType.GRASS).harvestLevel(0).strength(0.5F, 3.0F).dynamicShape());});
        HiwadabukiStairs = BLOCKS.register("hiwadabuki_stairs", () -> {return new StairsBlock(((Block)HiwadabukiBlock.get()).defaultBlockState(), AbstractBlock.Properties.of(Material.GRASS, MaterialColor.TERRACOTTA_BLACK).harvestTool(ToolType.SHOVEL).sound(SoundType.GRASS).harvestLevel(0).strength(0.5F, 3.0F));});
        HiwadabukiRoof45 = BLOCKS.register("hiwadabuki_roof_45", () -> {return new Roof45Block(AbstractBlock.Properties.of(Material.GRASS, MaterialColor.TERRACOTTA_BLACK).harvestTool(ToolType.SHOVEL).sound(SoundType.GRASS).harvestLevel(0).strength(0.5F, 3.0F).noOcclusion().dynamicShape());});
        HiwadabukiRoof225 = BLOCKS.register("hiwadabuki_roof_225", () -> {return new Roof225Block(AbstractBlock.Properties.of(Material.GRASS, MaterialColor.TERRACOTTA_BLACK).harvestTool(ToolType.SHOVEL).sound(SoundType.GRASS).harvestLevel(0).strength(0.5F, 3.0F).noOcclusion().dynamicShape());});
        //DirtFurnace = BLOCKS.register("dirt_furnace", () -> {return new DirtFurnaceBlock(AbstractBlock.Properties.of(Material.DIRT, MaterialColor.DIRT).harvestTool(ToolType.SHOVEL).sound(SoundType.GRAVEL).harvestLevel(0).strength(1.0F, 10.0F).noOcclusion().dynamicShape());});
