...
public class WoodenCabinetryBlock extends ContainerBlock {
    public static final DirectionProperty FACING = BlockStateProperties.HORIZONTAL_FACING;
    public static final BooleanProperty OPEN = BlockStateProperties.OPEN;

    public WoodenCabinetryBlock(AbstractBlock.Properties p_i49996_1_) {
        super(p_i49996_1_);
    ...
    public void tick(BlockState p_225534_1_, ServerWorld p_225534_2_, BlockPos p_225534_3_, Random p_225534_4_) {
        ...
        if (tileentity instanceof WoodenCabinetryTileEntity) {
            ((WoodenCabinetryTileEntity)tileentity).recheckOpen();
        }
    ...
    public TileEntity newBlockEntity(IBlockReader p_196283_1_) {
        return new WoodenCabinetryTileEntity();
    }
    ...
    public void setPlacedBy(World p_180633_1_, BlockPos p_180633_2_, BlockState p_180633_3_, @Nullable LivingEntity p_180633_4_, ItemStack p_180633_5_) {
        if (p_180633_5_.hasCustomHoverName()) {
            ...
            if (tileentity instanceof WoodenCabinetryTileEntity) {
                ((WoodenCabinetryTileEntity)tileentity).setCustomName(p_180633_5_.getHoverName());
            }
        }
