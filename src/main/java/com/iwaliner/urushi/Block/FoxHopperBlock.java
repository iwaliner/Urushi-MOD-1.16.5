...
public class FoxHopperBlock extends HopperBlock {
    ...
    private static final VoxelShape BASE = VoxelShapes.join(CONVEX_BASE, IFoxHopper.INSIDE, IBooleanFunction.ONLY_FIRST);
    ...
    private static final VoxelShape DOWN_INTERACTION_SHAPE = IFoxHopper.INSIDE;
    private static final VoxelShape EAST_INTERACTION_SHAPE = VoxelShapes.or(IFoxHopper.INSIDE, Block.box(12.0D, 8.0D, 6.0D, 16.0D, 10.0D, 10.0D));
    private static final VoxelShape NORTH_INTERACTION_SHAPE = VoxelShapes.or(IFoxHopper.INSIDE, Block.box(6.0D, 8.0D, 0.0D, 10.0D, 10.0D, 4.0D));
    private static final VoxelShape SOUTH_INTERACTION_SHAPE = VoxelShapes.or(IFoxHopper.INSIDE, Block.box(6.0D, 8.0D, 12.0D, 10.0D, 10.0D, 16.0D));
    private static final VoxelShape WEST_INTERACTION_SHAPE = VoxelShapes.or(IFoxHopper.INSIDE, Block.box(0.0D, 8.0D, 6.0D, 4.0D, 10.0D, 10.0D));

    public FoxHopperBlock(AbstractBlock.Properties p_i48378_1_) {
        super(p_i48378_1_);
    ...
    public TileEntity newBlockEntity(IBlockReader p_196283_1_) {
        return new FoxHopperTileEntity();
    }

    public void setPlacedBy(World p_180633_1_, BlockPos p_180633_2_, BlockState p_180633_3_, LivingEntity p_180633_4_, ItemStack p_180633_5_) {
        if (p_180633_5_.hasCustomHoverName()) {
            TileEntity tileentity = p_180633_1_.getBlockEntity(p_180633_2_);
            if (tileentity instanceof FoxHopperTileEntity) {
                ((FoxHopperTileEntity)tileentity).setCustomName(p_180633_5_.getHoverName());
            }
        }
    ...
    public ActionResultType use(BlockState p_225533_1_, World p_225533_2_, BlockPos p_225533_3_, PlayerEntity p_225533_4_, Hand p_225533_5_, BlockRayTraceResult p_225533_6_) {
        if (p_225533_2_.isClientSide) {
            ...
            if (tileentity instanceof FoxHopperTileEntity) {
                p_225533_4_.openMenu((FoxHopperTileEntity)tileentity);
    ...
    public void onRemove(BlockState p_196243_1_, World p_196243_2_, BlockPos p_196243_3_, BlockState p_196243_4_, boolean p_196243_5_) {
        if (!p_196243_1_.is(p_196243_4_.getBlock())) {
            ...
            if (tileentity instanceof FoxHopperTileEntity) {
                InventoryHelper.dropContents(p_196243_2_, p_196243_3_, (FoxHopperTileEntity)tileentity);
    ...
    public void entityInside(BlockState p_196262_1_, World p_196262_2_, BlockPos p_196262_3_, Entity p_196262_4_) {
        ...
        if (tileentity instanceof FoxHopperTileEntity) {
            ((FoxHopperTileEntity)tileentity).entityInside(p_196262_4_);
        }
